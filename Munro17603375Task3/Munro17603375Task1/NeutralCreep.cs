...
namespace Munro17603375Task1
{
    class NeutralCreep : Unit
    {
        ...
        public override void save()
        {
            ...
            try
            {
                outFile = new FileStream(@"Files\CreepUnits.txt", FileMode.Append, FileAccess.Write);
                ...
                units.WriteLine(minXBoundary);
                units.WriteLine(maxXBoundary);
                units.WriteLine(minYBoundary);
                units.WriteLine(maxYBoundary);
                units.Close();
                outFile.Close();
            }
            catch (Exception e)
